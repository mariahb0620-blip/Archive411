...
export function mapProductRow(row: Record<string, unknown>): Product {
  return {
    ...
    sourceType: row.source_type as Product["sourceType"],
    sourceProductId: row.source_product_id as string | undefined,
    retailerName: row.retailer_name as string | undefined,
    designerName: row.designer_name as string | undefined,
    ...
    footwearType: row.footwear_type as string | undefined,
    heelHeight: row.heel_height as string | undefined,
    ...
    affiliateNetwork: row.affiliate_network as Product["affiliateNetwork"],
    stockStatus: row.stock_status as string | undefined,
  };
}
